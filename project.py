...
relief=SUNKEN) # A relief is a border decoration. The possible values are:SUNKEN,RAISED,GROOVE,RIDGE,and FLAT.
Tops.pack(side=TOP)
...
CostofMeal = "Rs", str(
'%.2f' % (CostofFries + CostofNoodles + CostofSoup + CostBurger + CostSandwich))

PayTax = ((CostofFries + CostofNoodles + CostofSoup + CostBurger + CostSandwich) * 0.2)

TotalCost = (CostofFries + CostofNoodles + CostofSoup + CostBurger + CostSandwich)

Ser_Charge = ((CostofFries + CostofNoodles + CostofSoup + CostBurger + CostSandwich) / 99)
